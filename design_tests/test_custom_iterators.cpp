...
/*
 ...
 custom STL-compatible iterators, to check under which conditions
 generic algorithms from <algorithm> like std::equal do compile.
 The reason to setup such a test was that std::equal does not work in
 InfiniteVector::operator == () when compiling with CLang under macOS.
